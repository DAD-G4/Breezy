    ...
    >
      ...
      {onUndo && (
        <button
          ...
          className="ml-2 px-3 py-1 text-xs font-bold rounded-full bg-steel-blue/20 dark:bg-deep-space-blue/20 text-steel-blue dark:text-papaya-whip hover:bg-steel-blue/30 dark:hover:bg-deep-space-blue/30 transition-colors"
        >
          Undo
        </button>
      )}
