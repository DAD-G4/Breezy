...
import { updateSettings, getBlockedUsers, unblockUser } from "@/services/users";
    ...
    <AppShell>
      <div className="flex flex-col p-4 gap-6">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-4 p-4 rounded-xl border border-gray-200 dark:border-steel-blue/40 bg-white dark:bg-deep-space-blue shadow-sm">
          ...
          {blockedUsers.map((u) => (
            ...
            >
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-semibold rounded-full bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30 transition-colors"
              >
